        ...
        <div className='header-container' onClick={() => setShowHeaderOptions(!showHeaderOptions)}>
            <div className='header-parent'>
                ...
                <div className='header-logo'>
                    <span className='logo'><span className='word'>S</span><span className='word'>a</span><span className='word'>q</span><span className='word'>l</span><span className='word'>a</span><span className='word'>i</span></span><span className='word'>n</span>
                </div>
